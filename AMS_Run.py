    ...
    def fill_attendance():
        ...
        try:
            ...
            connection = pymysql.connect(
                host='localhost', user='root', password='toor', db='manually_fill_attendance')
        ...
        if subb == '':
            ...
            def attf():
                ...
                subprocess.Popen(r'explorer /select,"C:\Users\kunal chaudhari\Desktop\Face-Recognition-Attendance-System-main\Attendance\Manually Attendance"')
